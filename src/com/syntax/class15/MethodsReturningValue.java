...
//compare 2 numbers and then we will identify whether the largest number is even or odd
		
		Largest obj=new Largest();
		//int num=obj.Largest(10, 20);CE: since isLarger does not return any value 
	...
	boolean isOdd(int num) {//void isOdd(int num) {-->before we switched to void
		//void -->is used to return anything
		boolean isOdd;
		if(num%2==0) {
			isOdd=false;
		}else {
