...
public class MethodsRecap {
	...
	//create a method that will accept array of integer and return max elements
	...
	int getLargestNumber(int[] array) {
	    ...
	    //create a method that will accept String and return each word from a given String 
