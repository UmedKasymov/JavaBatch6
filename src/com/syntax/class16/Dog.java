...
public class Dog {
  ...
  System.out.println("Dogs breed is "+breed+" and it has "+paws+"paws and "+tail+" tail");
	...
	public static void main(String[] args) {
            //local
		Dog dog1 = new Dog();
		//how to access instance variables? --by creating an object and using reference 
		
		dog1.name = "Lucy";//name--instance variable
		dog1.size = "Big";
		dog1.age = 5;
		dog1.age=6;
		dog1.displayDog();
		
        //hot to acces static varibles ?--static variable belong to the class--
